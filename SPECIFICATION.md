...
### 7.7 人数差補正 / ナイトバフ
- **人数差補正**: 開始時（キット選択完了時）に 1v2 以上の不利側へ Speed I + Regeneration I を 8秒付与
- **ナイトバフ**: 開始時に人数不利だったプレイヤーが、現在も人数不利（条件2はリス不可モードのみ判定。TDM/占領戦/CTFは条件1のみ）のとき、被弾で攻撃力上昇I(3秒)＋即時回復1。独立CT 8秒
